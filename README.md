...
The index acts as a welcome, and it should quickly tell the visitor what the site is about.

- About

The about page tells a bit about wargaming in general and the game Hordes of the Things in particular.

- Gallery

The gallery shows some images that hopefully are inspirational for the wargamer-to-be.

- Community

The community page has links to facebook groups, youtube videos, the Wargames Research Group, and blogs.
